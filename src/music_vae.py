...
# Set the model and parameters based on the music type selected by the BERT Model earlier.
...
# Use Magenta to generate a MIDI file and print out the parameters used for generation
...
# Unused: Apply reverb to a sound
...
# Use PyDub to generate a WAV file from the MIDI file generated by Magenta/MusicVAE
